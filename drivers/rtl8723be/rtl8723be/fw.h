...
#ifndef __RTL8723B__FW__H__
#define __RTL8723B__FW__H__
...
/* AOAC_RSVDPAGE_LOC */
#define SET_88E_H2CCMD_AOAC_RSVDPAGE_LOC_REMOTE_WAKE_CTRL_INFO(__pH2CCmd, __val)		\
	SET_BITS_TO_LE_1BYTE((__pH2CCmd), 0, 8, __val)
